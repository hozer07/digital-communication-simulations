...
qpsk_ber_SNR_exp = errs./nFrames/nBitsPerFrame;
qpsk_ber_SNR_theory = qfunc(sqrt(2.*Eb_No)).*(1-0.5.*qfunc(sqrt(2.*Eb_No)));
save QPSK_ber_Es_no.mat qpsk_ber_SNR_exp qpsk_ber_SNR_theory