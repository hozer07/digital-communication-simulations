...
No = 1./10.^(snr_db./10);
dmin = 2/sqrt(5);
pam_uniform_ber_SNR_exp = errs./nFrames/nBitsPerFrame;
pam_uniform_ber_SNR_theory = 5/4.*0.5.*3/2.*qfunc(dmin./sqrt(2.*No)); % 5/4 is average bit error assuming every symbol error is between neighboring symbols
...
ylim([1e-10 1]);
save 4pam_uniform.mat pam_uniform_ber_SNR_exp pam_uniform_ber_SNR_theory