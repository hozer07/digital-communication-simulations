...
SNR = 10.^(snr_db./10);
qpsk_ber_Eb_No_exp = errs./nFrames/nBitsPerFrame;
qpsk_ber_Eb_No_theory = qfunc(sqrt(2.*SNR)).*(1-0.5.*qfunc(sqrt(2.*SNR)));
save QPSK_ber_Eb_no.mat qpsk_ber_Eb_No_exp qpsk_ber_Eb_No_theory