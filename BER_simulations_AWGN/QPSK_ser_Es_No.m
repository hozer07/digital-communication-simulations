...
qpsk_ser_SNR_exp = errs./nFrames/nSymPerFrame;
qpsk_ser_SNR_theory = 2.*qfunc(sqrt(2.*Eb_No)).*(1-0.5.*qfunc(sqrt(2.*Eb_No)));
save QPSK_ser_Es_no.mat qpsk_ser_SNR_exp qpsk_ser_SNR_theory